...
//				if (!col.hasOneRelation()) {
					addInstr(entity.assignAttr(col.getCamelCaseName(),getParam("record").callMethod("value", new PhpStringPlusOperatorExpression(getParam("alias"), PhpString.fromStringConstant("__"+ col.getName()))).callMethod(EntityCls.getTypeMapper().getConvertMethod(col.getDbType()))));
//				}
