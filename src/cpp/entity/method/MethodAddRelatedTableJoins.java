...
public class MethodAddRelatedTableJoins extends Method {
	...
	public void addImplementation() {
		...
		for(ManyRelation r:bean.getManyRelations()) {
			...
			query = query.callMethod("leftJoin", QString.fromStringConstant(bean.getTbl().getSchema()+"."+r.getMappingTable().getName()),QString.fromStringConstant(r.getAlias("mapping")), QString.fromStringConstant(CodeUtil2.concat(joinConditions," AND ")));
