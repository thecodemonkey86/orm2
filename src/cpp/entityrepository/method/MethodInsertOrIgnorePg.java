...
public class MethodInsertOrIgnorePg extends TplMethod {
	Param pEntity;
	boolean byRef;
	public MethodInsertOrIgnorePg(MethodTemplate tpl,boolean byRef,Type...types) {
		super(tpl,types);
	...
	public void addImplementation() {
		addInstr(new Instruction() {
			...
			public String toString() {
				String a=byRef?".":"->";
				return String.format("QString query = QStringLiteral(\"INSERT INTO %%1 (%%2) VALUES (%%3) ON CONFLICT DO NOTHING\").arg(T::getTableName(), T::getInsertFields(), T::getInsertValuePlaceholders());\r\n" + 
