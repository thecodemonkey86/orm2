...
public class MethodJsonQueryOne extends Method{

	JsonEntity entity;
	Param pCallback;
	public MethodJsonQueryOne(JsonEntity entity) {
		super(Public, Types.Void, "queryOne");
		this.entity = entity;
		pCallback = addParam(new ClsStdFunction(Types.Void, entity.toSharedPtr()),"callback");
	}
	...
	public void addImplementation() {
		...
		addInstr(vUrlQuery.callMethodInstruction(ClsQUrlQuery.addQueryItem, QString.fromStringConstant("queryType"), QString.fromStringConstant("one")));
		...
		addInstr(JsonTypes.JsonEntityRepository.callStaticMethod(MethodLoadOneFromUrl.getMethodName(entity), vUrl, pCallback).asInstruction());
