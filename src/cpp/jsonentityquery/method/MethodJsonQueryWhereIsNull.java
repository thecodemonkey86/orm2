...
public class MethodJsonQueryWhereIsNull extends Method {
	...
	public static String getMethodName(Column col) {
		return "where"+col.getUc1stCamelCaseName() +"IsNotNull";
	}

	@Override
	public void addImplementation() {
		_callMethodInstr(_this(), ClsBaseJsonEntitySelectQuery.where,QString.fromStringConstant("e1."+col.getEscapedName()+"is not null")  );
